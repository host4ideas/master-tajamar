...
CREATE OR ALTER VIEW V_EMPLEADOS_HOSPITAL
AS
...
INSERT INTO HOSPITAL VALUES (33, 'El Carmen', 'Calle Carmen, 22', 88888, 250);

/*
	Procedures Form12
*/
CREATE OR ALTER PROCEDURE SP_OFICIOS
AS
	SELECT DISTINCT OFICIO FROM EMP;
GO

CREATE OR ALTER PROCEDURE SP_EMPLEADOS_OFICIO
(@OFICIO NVARCHAR(50) = '')
AS
	IF(@OFICIO = '') BEGIN
...
CREATE OR ALTER PROCEDURE SP_INCREMENTAR_SALARIO_OFICIO
