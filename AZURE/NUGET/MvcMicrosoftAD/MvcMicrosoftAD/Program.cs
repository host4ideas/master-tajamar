...
string connectionString = builder.Configuration.GetConnectionString("SqlServerLocal");
string appId = builder.Configuration.GetValue<string>("Authentication:Microsoft:AppId");
