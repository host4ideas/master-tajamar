...
namespace ServiceReference1
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Coche", Namespace="http://schemas.datacontract.org/2004/07/ServiceWCFLogicaCoches.Model")]
    ...
    public partial class CochesContractClient : System.ServiceModel.ClientBase<ServiceReference1.ICochesContract>, ServiceReference1.ICochesContract
    {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICochesContract))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:57181/ServiceWCFCoches.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
