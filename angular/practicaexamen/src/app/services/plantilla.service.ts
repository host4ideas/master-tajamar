...
export class PlantillaService {
   ...
   * @returns {Observable<any>} Observable al cual nos suscribiremos en el componente
   */
  getPerfilEmpleado(headers: HttpHeaders): Observable<any> {
    const request =
      environment.API_PLANTILLA + '/api/Empleados/PerfilEmpleado/';
    return this._http.get(request, { headers: headers });
  }
   ...
   * @returns {Observable<any>} Observable al cual nos suscribiremos en el componente
   */
  getSubordinados(headers: HttpHeaders): Observable<any> {
    const request = environment.API_PLANTILLA + '/api/Empleados/Subordinados/';
    return this._http.get(request, { headers: headers });
  }
}
